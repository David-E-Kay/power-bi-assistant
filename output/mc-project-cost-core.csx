...
{
    { "by_start_of_month", "'Calendar'[Start Of Month]" },
    { "by_property_market_reporting", "'Properties'[Property Market Reporting]" },
};
...
var crossProductColumns = new List<string>
{
    ...
    "'Properties'[Property Market Reporting]",
};
...
foreach (var measureName in measures)
{
    ...
    if (crossProductColumns.Count > 0)
    {
        testNum++;
        testId = "b" + testNum.ToString("D4");
        var contextLabel = "cross_product";
